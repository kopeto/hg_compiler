...
PuzExportDialog::PuzExportDialog(Grid& grid, QWidget* parent) : QDialog(parent) {
...
void PuzExportDialog::buildClueTable(Grid& grid) {
    ...
    auto addWordRow = [&](int wordNum, int r, int c, GridWordDirection dir) {
        ...
        // Column 1: word string — not editable
        QString wordStr;
